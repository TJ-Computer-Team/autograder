...
const app = express();
const port = 3000;
const gradeRouter = require("./autograder/routes/grade");
const adminRouter = require("./autograder/routes/admin");
const {
    populate
} = require("./profile");
...
app.use(favicon("./autograder/public/images/Logo.ico"));

app.use(express.static("./autograder/public"));
...
app.set('views', __dirname + '/autograder/views');
